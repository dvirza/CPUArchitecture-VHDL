...
# ----------------------------------------
# If PLL160 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 21.1 842 win32 2024.09.03.17:57:43
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/PLL160.vho"
}
